...
export default function TermsOfService() {
    return (
        <>
            <Head>
                <title>Terms of Service | Automaitee | AI Management & Marketing Automation</title>
                ...
                <meta property="og:title" content="Terms of Service | Automaitee | AI Management & Marketing Automation" />
                ...
                <meta name="twitter:title" content="Terms of Service | Automaitee | AI Management & Marketing Automation" />
            ...
            <div className="container" style={{ paddingTop: '120px', paddingBottom: '60px' }}>
                ...
                <div style={{ maxWidth: '800px', lineHeight: '1.6', color: 'var(--text-secondary)' }}>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        ...
                        <p style={{ marginTop: '1rem' }}>Some services are provided on a recurring monthly subscription basis. By purchasing a subscription, clients authorise automatic renewal and billing each month until cancelled in accordance with our <Link href="/refund-policy" style={{ color: '#0071e3' }}>Refund &amp; Cancellation Policy</Link>.</p>
                    </section>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        ...
                        <p>All content, software, and branding on our website are owned by Automaitee AI and protected by law.</p>
                    </section>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        ...
                        <p>Questions or concerns? Email us at <a href="mailto:support@automaitee.com" style={{ color: '#0071e3' }}>support@automaitee.com</a>.</p>
                    </section>
                </div>
            </div>
        </>
