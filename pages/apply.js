...
export default function Apply() {
    ...
    const validateStep4 = () => {
        ...
        if (!formData.aiTools.trim()) errors.aiTools = "Required"   // ← added
    ...
    const validateStep5 = () => {
        ...
        else if (!/^\+?[0-9]{10,15}$/.test(formData.whatsapp.replace(/\s/g, ''))) errors.whatsapp = "Enter a valid number"
    ...
    const handleSubmit = async (e) => {
        ...
        const payload = {
            ...
            marketingTools: formData.marketingTools || null,
        ...
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_N8N_WEBHOOK_URL}/automation-intern-apply`, {
                method: 'POST',
    ...
    return (
        <>
            ...
            <div style={{ minHeight: '100vh', background: '#fbfbfd', padding: '10px 60px' }}>
                <AnimatePresence mode="wait">
                        ...
                        <motion.div key="p3" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95 }} style={{ ...modalStyle, maxWidth: '750px' }}>
                            ...
                            {[
                                ...
                                },
                                {
                                    ...
                                    a: 'Yes. The programme is open to eligible students from any college as long as you meet the eligibility criteria.'
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    a: 'Applications are open until seats are filled. Once the batch is confirmed, selected students will receive the schedule by email.'
                                },
                            ].map(({ q, a }) => (
                    ...
                    {/* ── FORM STAGE 1: Academic + Skills ── */}
                    {step === 4 && (
                        <motion.div key="p4" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95 }} style={{ maxWidth: '800px', margin: '100px auto', padding: '20px 20px' }}>
                                ...
                                <form onSubmit={handleStep4Submit}>
                                    ...
                                    <div style={{ marginBottom: '3rem' }}>
                                        <label style={fieldHeader}>
                                            Degree <span style={{ color: '#d93025' }}>*</span>
                                        </label>
                                        ...
                                        {formData.degree === 'related' && (
                                            <div style={{ marginTop: '1rem' }}>
                                                <label style={fieldHeader}>
                                                    Course Name <span style={{ color: '#d93025' }}>*</span>
                                                </label>
                                    ...
                                    <div style={{ marginBottom: '3rem' }}>
                                        ...
                                        <div style={{ marginBottom: '1.5rem' }}>
                                            <label style={fieldHeader}>
                                                Current Year <span style={{ color: '#d93025' }}>*</span>
                                            </label>
                                    ...
                                    <div style={{ marginBottom: '3rem' }}>
                                        ...
                                        <div style={{ marginBottom: '1.5rem' }}>
                                            <label style={{ ...fieldHeader, color: formErrors.codingLanguages ? '#d93025' : '#1d1d1f' }}>
                                                Coding languages known (JS / API / JSON etc.) <span style={{ color: '#d93025' }}>*</span>
                                            </label>
                                        ...
                                        {/* AI Tools — NOW REQUIRED */}
                                        <div style={{ marginBottom: '1.5rem' }}>
                                            <label style={{ ...fieldHeader, color: formErrors.aiTools ? '#d93025' : '#1d1d1f' }}>
                                                AI tools used independently <span style={{ color: '#d93025' }}>*</span>
                                            </label>
                                            <input type="text" name="aiTools" value={formData.aiTools} onChange={handleChange} style={{ ...inputStyle, borderColor: formErrors.aiTools ? '#d93025' : '#d2d2d7' }} placeholder="e.g. ChatGPT, Claude, Midjourney" />
                                            {formErrors.aiTools && <div style={{ color: '#d93025', fontSize: '0.85rem', marginTop: '0.35rem' }}>{formErrors.aiTools}</div>}
                                        </div>
                                    ...
                                    <div style={{ borderTop: '1px solid #eee', paddingTop: '2rem', display: 'flex', justifyContent: 'space-between', gap: '1rem', flexWrap: 'wrap' }}>
                                        ...
                                        <button type="submit" className="cta-button" style={{ padding: '1rem 3rem' }}>Next →</button>
                                    </div>
                                </form>
                            </div>
                        </motion.div>
                    ...
                    {/* ── FORM STAGE 2: Personal Details ── */}
                    {step === 5 && (
                        <motion.div key="p5" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95 }} style={{ maxWidth: '800px', margin: '80px auto', padding: '20px 20px' }}>
                            <Link href="/work-with-us" style={{ color: '#0071e3', fontWeight: '600', display: 'inline-block', marginBottom: '1.5rem' }}>← Cancel Application</Link>
                            ...
                            <div style={{ background: 'white', padding: '3rem', borderRadius: '1rem', boxShadow: '0 10px 40px rgba(0,0,0,0.05)' }}>
                                ...
                                {submitStatus === 'error' && (
                                    <div style={{ background: '#fef2f2', border: '1px solid #fecaca', color: '#991b1b', padding: '1rem', borderRadius: '0.5rem', marginBottom: '1.5rem', fontSize: '0.95rem' }}>
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className="responsive-grid" style={{ marginBottom: '1.5rem' }}>
                                        <div>
                                            <label style={{ ...fieldHeader, color: formErrors.fullName ? '#d93025' : '#1d1d1f' }}>
                                        ...
                                        <div>
                                            <label style={{ ...fieldHeader, color: formErrors.email ? '#d93025' : '#1d1d1f' }}>
                                    ...
                                    <div className="responsive-grid" style={{ marginBottom: '1.5rem' }}>
                                        <div>
                                            <label style={{ ...fieldHeader, color: formErrors.whatsapp ? '#d93025' : '#1d1d1f' }}>
                                                WhatsApp Number <span style={{ color: '#d93025' }}>*</span>
                                            </label>
                                            <input type="tel" name="whatsapp" value={formData.whatsapp} onChange={handleChange} style={{ ...inputStyle, borderColor: formErrors.whatsapp ? '#d93025' : '#d2d2d7' }} placeholder="+91 XXXXX XXXXX" />
                                            {formErrors.whatsapp && <div style={{ color: '#d93025', fontSize: '0.85rem', marginTop: '0.35rem' }}>{formErrors.whatsapp}</div>}
                                        </div>
                                        <div>
                                            <label style={{ ...fieldHeader, color: formErrors.location ? '#d93025' : '#1d1d1f' }}>
                                                Location (City) <span style={{ color: '#d93025' }}>*</span>
                                            </label>
                                    ...
                                    <div style={{ marginBottom: '1.5rem' }}>
                                        <label style={{ ...fieldHeader, color: formErrors.whyInternship ? '#d93025' : '#1d1d1f' }}>
                                            Why do you want this internship? <span style={{ color: '#86868b', fontWeight: 'normal' }}>(Max 150 words)</span> <span style={{ color: '#d93025' }}>*</span>
                                        </label>
                                    ...
                                    <div style={{ marginBottom: '1.5rem' }}>
                                        <label style={{ ...fieldHeader, color: formErrors.whatToLearn ? '#d93025' : '#1d1d1f' }}>
                                            What do you expect to learn? <span style={{ color: '#86868b', fontWeight: 'normal' }}>(Max 150 words)</span> <span style={{ color: '#d93025' }}>*</span>
                                        </label>
                                    ...
                                    <div style={{ borderTop: '1px solid #eee', paddingTop: '2rem', display: 'flex', justifyContent: 'space-between', gap: '1rem', flexWrap: 'wrap' }}>
                                        ...
                                        <button
                                            ...
                                            style={{ padding: '1rem 3rem', opacity: submitStatus === 'submitting' ? 0.7 : 1, cursor: submitStatus === 'submitting' ? 'not-allowed' : 'pointer' }}
                                        >
