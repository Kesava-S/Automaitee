            ...
            <div className="container" style={{ paddingTop: '120px', paddingBottom: '60px' }}>
                ...
                <div style={{ maxWidth: '800px', lineHeight: '1.6', color: 'var(--text-secondary)' }}>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        ...
                        <p>Automaitee AI (“we,” “our,” “us”) respects your privacy. This policy explains how we collect, use, and protect your personal data when you use our website or services.</p>
                    </section>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        ...
                        <p>For questions, data requests, or complaints, contact: <a href="mailto:support@automaitee.com" style={{ color: '#0071e3' }}>support@automaitee.com</a></p>
