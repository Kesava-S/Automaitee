                ...
                <div className="container">
                    ...
                    <div className="grid">
                        ...
                        <Reveal>
                            <div className="card" style={{ height: '100%', padding: '2rem' }}>
                                ...
                                <a href="mailto:support@automaitee.com?subject=Application%20for%20AI%20Automation%20Engineer" style={{ color: '#0071e3', fontWeight: 'bold' }}>Apply Now →</a>
                            </div>
                        </Reveal>
                        ...
                        <Reveal delay={0.2}>
                            <div className="card" style={{ height: '100%', padding: '2rem' }}>
                                ...
                                <a href="mailto:support@automaitee.com?subject=Application%20for%20Automation%20Consultant" style={{ color: '#0071e3', fontWeight: 'bold' }}>Apply Now →</a>
                            </div>
                        </Reveal>
                    </div>
                    ...
                    <Reveal width="100%">
                        <div style={{ textAlign: 'center', marginTop: '5rem', padding: '3rem 2rem', background: 'white', borderRadius: '1rem', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }}>
                            ...
                            <a href="mailto:support@automaitee.com" className="cta-button">
                                Email Us: support@automaitee.com
                            </a>
                        </div>
                    </Reveal>
                </div>
